...
const TRAINERS = [
  {
    ...
    description: 'Certified yoga instructor with 10+ years of experience. Sarah specializes in Vinyasa and restorative yoga, helping clients find balance in their busy lives.',
    image: 'https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?w=600&q=80',
  },
  {
    id: 'marcus',
    name: 'Marcus Johnson',
    specialization: 'HIIT & Athletic Training',
    description: 'Former college athlete and certified personal trainer. Marcus brings high energy and motivation to every session, specializing in functional fitness and HIIT.',
  ...
  },
  {
    ...
    description: 'Strength coach with expertise in powerlifting and bodybuilding. Jessica helps clients build muscle, increase strength, and boost confidence.',
          ...
          <div className="bg-card rounded-2xl border border-gray-200/80 p-6 shadow-sm transition-all duration-300 ease-out hover:shadow-md">
            ...
            <div className="space-y-3 text-gray-600">
              ...
              <p className="flex items-center gap-2">
                <svg className="w-5 h-5 text-primary-600 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden>
          ...
          <div className="bg-card rounded-2xl border border-gray-200/80 p-6 shadow-sm transition-all duration-300 ease-out hover:shadow-md">
            ...
            <div className="space-y-3 text-gray-600">
              ...
              <p className="text-sm text-gray-500 pt-2 border-t border-gray-100 mt-4">
                Premium members have 24/7 access with their key card.
              </p>
            </div>
          </div>
        </div>
