            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2.5 rounded-lg border border-gray-200 bg-surface text-gray-800 placeholder-gray-400 focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                    required
                  />
                </div>
                <div>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    className="w-full px-4 py-2.5 rounded-lg border border-gray-200 bg-surface text-gray-800 focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                  >
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  rows={4}
                  className="w-full px-4 py-2.5 rounded-lg border border-gray-200 bg-surface text-gray-800 placeholder-gray-400 focus:ring-2 focus:ring-primary-500 focus:border-transparent resize-y"
                  required
                />
              </div>
              <button
                type="submit"
                className="flex items-center justify-center gap-2 w-full sm:w-auto px-6 py-3 rounded-xl bg-primary-600 text-white font-medium transition-all duration-200 hover:bg-primary-700 hover:scale-[1.02] hover:shadow-md focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2"
              >
        ...
        <div className="lg:col-span-2 space-y-4">
          <div className="bg-card rounded-2xl border border-gray-200/80 p-6 shadow-sm">
            ...
            <div className="space-y-4 text-gray-700">
              <div className="flex items-start gap-3">
                <svg className="w-5 h-5 text-primary-600 shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden>
          ...
          <div className="rounded-2xl bg-primary-600 p-6 text-white transition-shadow duration-300 hover:shadow-lg">
            ...
            <p className="text-sm text-white/90 mb-4">
              Want to see our facility in person? Schedule a free tour and trial session!
            </p>
            <Link
              to="/booking"
              className="inline-block px-4 py-2.5 rounded-xl bg-white text-primary-600 font-medium text-sm border-2 border-white transition-all duration-200 hover:scale-[1.02] hover:shadow-md"
            >
              Schedule a Tour
            </Link>
          </div>
